...
from ui_settings_widgets import ColorPickerWidget, ModernSpinBox, ToggleSwitch
...
class SettingsPagesMixin:
    ...
    def _page_general(self):
        ...
        self._add_input_card(
            ...
            "分割間隔",
            segment_widget,
            "長くしすぎると、再生が重くなりますため、適切な値に設定してください。",
        )
    ...
    def _page_gdrive(self):
        ...
        self._add_section_label(layout, "Google Drive", with_separator=False)
